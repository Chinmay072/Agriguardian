...
try:
    with open(r"/Users/devmehta/Desktop/DAIICT_hackout/best_crop_yield_model.pkl", 'rb') as model_file:
        model = pickle.load(model_file)
    
    with open(r"/Users/devmehta/Desktop/DAIICT_hackout/label_encoders_yield.pkl", 'rb') as encoder_file:
